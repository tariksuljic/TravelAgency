  ...
  list: function() {
    ...
    <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <a href="#" class="btn btn-primary editUser" onclick="usersService.get(` + data[i].id + `)">
            EDIT
          </a>
          <a href="#" class="btn btn-primary editUser" onclick="usersService.delete(` + data[i].id + `)">
            DELETE
          </a>
        </div>
    </div>
